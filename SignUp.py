...
class Signup:
    def __init__(self, window):
        ...
        self.nickname_lbl = tk.Label(window, text="Nickname", bg="#36393f", fg="white")
        self.name_lbl = tk.Label(window, text="Name", bg="#36393f", fg="white")
        self.surname_lbl = tk.Label(window, text="Surname", bg="#36393f", fg="white")
        self.email_lbl = tk.Label(window, text="Email", bg="#36393f", fg="white")
        self.password_lbl = tk.Label(window, text="Password", bg="#36393f", fg="white")
